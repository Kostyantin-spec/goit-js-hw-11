...
${frame.code}`;
    ...
    "8lqZg": [
      function (require, module, exports) {
        ...
        var _pixabayServiceDefault =
          parcelHelpers.interopDefault(_pixabayService);
        var _galleryMarkup = require("./js/gallery-markup");
        var _galleryMarkupDefault =
          parcelHelpers.interopDefault(_galleryMarkup);
        const refs = {
        ...
        async function submitBtnHandler(event) {
          ...
          page = 1;
          if (!searchQuery.trim())
            return (0, _notiflixDefault.default).Notify.warning(
          ...
          try {
            const queryData = await (0, _pixabayServiceDefault.default)(
              searchQuery,
              page
            );
            form.reset();
            ...
            if (queryData.hits.length >= 40)
              (0, _notiflixDefault.default).Notify.success(
                `You have received ${queryData.totalHits} images`,
                {
                  distance: "90px",
                  position: "center-top",
                }
            ...
            if (queryData.hits.length < 40)
              refs.loadMoreBtn.classList.add("is-hidden"),
                (0, _notiflixDefault.default).Notify.failure(
                  "We're sorry, but you've reached the end of search results."
                );
            else refs.loadMoreBtn.classList.remove("is-hidden");
            refs.galleryEl.innerHTML = (0, _galleryMarkupDefault.default)(
              queryData.hits
            );
        ...
        async function loadMoreBtnHandler() {
          ...
          try {
            ...
            refs.galleryEl.insertAdjacentHTML(
              "beforeend",
              (0, _galleryMarkupDefault.default)(queryData.hits)
            );
      ...
      },
      {
        ...
        "./js/pixabay-service": "lnF2r",
        "./js/gallery-markup": "h0ve4",
    ...
    "5z0Oc": [
      function (require, module, exports) {
        var global = arguments[3];
        /* Notiflix AIO (https://notiflix.github.io) - Version: 3.2.6 - Author: Furkan (https://github.com/furcan) - Copyright 2019 - 2023 Notiflix, MIT Licence (https://opensource.org/licenses/MIT) */ (function (
          t,
          e
        ) {
          ...
          function (t1) {
            "use strict";
            if ("undefined" == typeof t1 && "undefined" == typeof t1.document)
              return !1;
            var e1,
              i1,
              a1,
              ...
              h1 = function (e, i) {
                ...
                if (null !== e() && !t1.document.getElementById(i)) {
                  ...
                  (a.id = i),
                    (a.innerHTML = e()),
                    t1.document.head.appendChild(a);
                }
              },
              v = function () {
                var t = {},
              ...
              F1 = function (a, n, o, r) {
                ...
                T1++,
                  ...
                  "shadow" === e1.fontAwesomeIconStyle &&
                    (f.fontAwesomeIconColor = f.background),
                  e1.cssAnimation || (e1.cssAnimationDuration = 0);
                var d =
                  t1.document.getElementById(m1.wrapID) ||
                  t1.document.createElement("div");
                if (
                  ((d.id = m1.wrapID),
                  (d.style.width = e1.width),
                  (d.style.zIndex = e1.zindex),
                  (d.style.opacity = e1.opacity),
                  "center-center" === e1.position
                    ? ((d.style.left = e1.distance),
                      (d.style.top = e1.distance),
                      (d.style.right = e1.distance),
                      (d.style.bottom = e1.distance),
                      (d.style.margin = "auto"),
                    ...
                    : "center-top" === e1.position
                    ? ((d.style.left = e1.distance),
                      (d.style.right = e1.distance),
                      (d.style.top = e1.distance),
                      (d.style.bottom = "auto"),
                      (d.style.margin = "auto"))
                    : "center-bottom" === e1.position
                    ? ((d.style.left = e1.distance),
                      (d.style.right = e1.distance),
                      (d.style.bottom = e1.distance),
                      (d.style.top = "auto"),
                      (d.style.margin = "auto"))
                    : "right-bottom" === e1.position
                    ? ((d.style.right = e1.distance),
                      (d.style.bottom = e1.distance),
                      (d.style.top = "auto"),
                      (d.style.left = "auto"))
                    : "left-top" === e1.position
                    ? ((d.style.left = e1.distance),
                      (d.style.top = e1.distance),
                      (d.style.right = "auto"),
                      (d.style.bottom = "auto"))
                    : "left-bottom" === e1.position
                    ? ((d.style.left = e1.distance),
                      (d.style.bottom = e1.distance),
                      (d.style.top = "auto"),
                      (d.style.right = "auto"))
                  ...
                  var x =
                    t1.document.getElementById(m1.overlayID) ||
                    t1.document.createElement("div");
                  (x.id = m1.overlayID),
                    (x.style.width = "100%"),
                    (x.style.height = "100%"),
                    (x.style.position = "fixed"),
                    (x.style.zIndex = e1.zindex - 1),
                    (x.style.left = 0),
                    (x.style.top = 0),
                    (x.style.right = 0),
                    (x.style.bottom = 0),
                    (x.style.background =
                      f.backOverlayColor || e1.backOverlayColor),
                    (x.className = e1.cssAnimation ? "nx-with-animation" : ""),
                    (x.style.animationDuration = e1.cssAnimation
                      ? e1.cssAnimationDuration + "ms"
                      : ""),
                    t1.document.getElementById(m1.overlayID) ||
                      t1.document.body.appendChild(x);
                }
                t1.document.getElementById(m1.wrapID) ||
                  t1.document.body.appendChild(d);
                ...
                (g.id = e1.ID + "-" + T1),
                  (g.className =
                    ...
                    f.childClassName +
                    " " +
                    (e1.cssAnimation ? "nx-with-animation" : "") +
                    " " +
                    (e1.useIcon ? "nx-with-icon" : "") +
                    " nx-" +
                    e1.cssAnimationStyle +
                    " " +
                    ...
                    " " +
                    (e1.clickToClose ? "nx-notify-click-to-close" : "")),
                  (g.style.fontSize = e1.fontSize),
                  (g.style.color = f.textColor),
                  (g.style.background = f.background),
                  (g.style.borderRadius = e1.borderRadius),
                  (g.style.pointerEvents = "all"),
                  e1.rtl &&
                    (g.setAttribute("dir", "rtl"),
                    g.classList.add("nx-rtl-on")),
                  (g.style.fontFamily = '"' + e1.fontFamily + '", ' + s1),
                  e1.cssAnimation &&
                ...
                if (
                  ...
                  g.innerHTML =
                    ...
                    "</span>" +
                    (e1.closeButton ? b : "");
                else if (e1.useFontAwesome)
                  g.innerHTML =
                    '<i style="color:' +
                    f.fontAwesomeIconColor +
                    "; font-size:" +
                    e1.fontAwesomeIconSize +
                ...
                if (k) {
                  ...
                  if (
                    (("function" == typeof o || e1.clickToClose) &&
                ...
                if (e1.showOnlyTheLastOne && 0 < T1)
                  for (
                    var I,
                      R = t1.document.querySelectorAll(
                        "[id^=" +
                          e1.ID +
                          "-]:not([id=" +
                          e1.ID +
              ...
              j1 = function (e2, a3, n, o, r, l) {
                ...
                "string" != typeof a3 && (a3 = "Notiflix " + e2),
                  "string" != typeof n &&
                    (e2 === c1.Success
                      ? (n =
                  ...
                  i1.plainText && ((a3 = N(a3)), (n = N(n)), (o = N(o))),
                  i1.plainText ||
                    (a3.length > i1.titleMaxLength &&
                      ((a3 = "Possible HTML Tags Error"),
                      (n =
                        'The "plainText" option is "false" and the title content length is more than the "titleMaxLength" option.'),
                      (o = "Okay")),
                    n.length > i1.messageMaxLength &&
                      ((a3 = "Possible HTML Tags Error"),
                      (n =
                        'The "plainText" option is "false" and the message content length is more than the "messageMaxLength" option.'),
                      (o = "Okay")),
                    o.length > i1.buttonMaxLength &&
                      ((a3 = "Possible HTML Tags Error"),
                      (n =
                        'The "plainText" option is "false" and the button content length is more than the "buttonMaxLength" option.'),
                      (o = "Okay"))),
                  a3.length > i1.titleMaxLength &&
                    (a3 = a3.substring(0, i1.titleMaxLength) + "..."),
                  n.length > i1.messageMaxLength &&
                    (n = n.substring(0, i1.messageMaxLength) + "..."),
                  o.length > i1.buttonMaxLength &&
                    (o = o.substring(0, i1.buttonMaxLength) + "..."),
                  i1.cssAnimation || (i1.cssAnimationDuration = 0);
                var x = t1.document.createElement("div");
                (x.id = p1.ID),
                  (x.className = i1.className),
                  (x.style.zIndex = i1.zindex),
                  (x.style.borderRadius = i1.borderRadius),
                  (x.style.fontFamily = '"' + i1.fontFamily + '", ' + s1),
                  i1.rtl &&
                ...
                var g = "",
                  b = !0 === i1.backOverlayClickToClose;
                i1.backOverlay &&
                  (g =
                    '<div class="' +
                    i1.className +
                    "-overlay" +
                    (i1.cssAnimation ? " nx-with-animation" : "") +
                    (b ? " nx-report-click-to-close" : "") +
                    '" style="background:' +
                    (d.backOverlayColor || i1.backOverlayColor) +
                    ";animation-duration:" +
                ...
                if (
                  (e2 === c1.Success
                    ? (u = C1(i1.svgSize, d.svgColor))
                    : e2 === c1.Failure
                    ? (u = z1(i1.svgSize, d.svgColor))
                    : e2 === c1.Warning
                    ? (u = S1(i1.svgSize, d.svgColor))
                    : e2 === c1.Info && (u = L1(i1.svgSize, d.svgColor)),
                  (x.innerHTML =
                    g +
                    '<div class="' +
                    i1.className +
                    ...
                    o +
                    "</a></div>"),
                  !t1.document.getElementById(x.id))
                ) {
                  t1.document.body.appendChild(x);
                  var y = function () {
                  ...
                  if (
                    ...
                    var h = t1.document.querySelector(
              ...
              H1 = function (e, i2, n2, o, r, l, m, c, p) {
                ...
                "object" != typeof p || Array.isArray(p) || (a1 = v(!0, a1, p)),
                  ...
                  a1.plainText ||
                    ...
                    (r.length || l.length) > a1.buttonsMaxLength &&
                      ...
                      (l = "..."))),
                  i2.length > a1.titleMaxLength &&
                    (i2 = i2.substring(0, a1.titleMaxLength) + "..."),
                  n2.length > a1.messageMaxLength &&
                    (n2 = n2.substring(0, a1.messageMaxLength) + "..."),
                  r.length > a1.buttonsMaxLength &&
                    (r = r.substring(0, a1.buttonsMaxLength) + "..."),
                  l.length > a1.buttonsMaxLength &&
                    (l = l.substring(0, a1.buttonsMaxLength) + "..."),
                  a1.cssAnimation || (a1.cssAnimationDuration = 0);
                var g = t1.document.createElement("div");
                (g.id = d1.ID),
                  (g.className =
                    a1.className +
                    (a1.cssAnimation
                      ? " nx-with-animation nx-" + a1.cssAnimationStyle
                      : "")),
                  (g.style.zIndex = a1.zindex),
                  (g.style.padding = a1.distance),
                  a1.rtl &&
                    (g.setAttribute("dir", "rtl"),
                    g.classList.add("nx-rtl-on"));
                var b =
                  "string" == typeof a1.position
                    ? a1.position.trim()
                    : "center";
                g.classList.add("nx-position-" + b),
                  (g.style.fontFamily = '"' + a1.fontFamily + '", ' + s1);
                var u = "";
                a1.backOverlay &&
                  (u =
                    '<div class="' +
                    a1.className +
                    "-overlay" +
                    (a1.cssAnimation ? " nx-with-animation" : "") +
                    '" style="background:' +
                    a1.backOverlayColor +
                    ";animation-duration:" +
                ...
                "function" == typeof m &&
                  (y =
                    ...
                    a1.cancelButtonColor +
                    ";background:" +
                    a1.cancelButtonBackground +
                    ";font-size:" +
                    a1.buttonsFontSize +
                    ';">' +
                    l +
                ...
                if (
                  ((g.innerHTML =
                    ...
                    y +
                    "</div></div>"),
                  !t1.document.getElementById(g.id))
                ) {
                  t1.document.body.appendChild(g);
                  var L = t1.document.getElementById(g.id),
                    W = t1.document.getElementById("NXConfirmButtonOk"),
                    I = t1.document.getElementById("NXConfirmValidationInput");
                  if (
                    (I &&
                      (I.focus(),
              ...
              U1 = function (e, i, a, o, r) {
                ...
                if (("string" == typeof i && 0 < i.length && (c = i), o)) {
                  c =
                    c.length > n1.messageMaxLength
                      ? N(c).toString().substring(0, n1.messageMaxLength) +
                        "..."
                      : N(c).toString();
                  var p = "";
                  0 < c.length &&
                    (p =
                      ...
                      c +
                      "</p>"),
                    n1.cssAnimation || (n1.cssAnimationDuration = 0);
                  var f = "";
                  if (e === x1.Standard) f = W1(n1.svgSize, n1.svgColor);
                    ...
                    e === x1.Custom &&
                    null !== n1.customSvgCode &&
                    null === n1.customSvgUrl
                  )
                    f = n1.customSvgCode || "";
                  else if (
                    e === x1.Custom &&
                    ...
                    if (
                      e === x1.Custom &&
                      (null === n1.customSvgUrl || null === n1.customSvgCode)
                    )
                      return (
                        y1(
                  ...
                  var d = parseInt((n1.svgSize || "").replace(/[^0-9]/g, "")),
                    b = t1.innerWidth,
                    u = d >= b ? b - 40 + "px" : d + "px",
                    k =
                      '<div style="width:' +
                      ...
                      f +
                      "</div>",
                    h = t1.document.createElement("div");
                  if (
                    ((h.id = g1.ID),
                    (h.className =
                      n1.className +
                      (n1.cssAnimation ? " nx-with-animation" : "") +
                      (n1.clickToClose ? " nx-loading-click-to-close" : "")),
                    (h.style.zIndex = n1.zindex),
                    (h.style.background = n1.backgroundColor),
                    (h.style.animationDuration =
                      n1.cssAnimationDuration + "ms"),
                    (h.style.fontFamily = '"' + n1.fontFamily + '", ' + s1),
                    ...
                    (h.innerHTML = k + p),
                    !t1.document.getElementById(h.id) &&
                      (t1.document.body.appendChild(h), n1.clickToClose))
                  ) {
                ...
                } else if (t1.document.getElementById(g1.ID))
                  var z = t1.document.getElementById(g1.ID),
              ...
              V1 = function (e) {
                ...
                if (i) {
                  if (0 < e.length) {
                    e =
                      e.length > n1.messageMaxLength
                        ? N(e).substring(0, n1.messageMaxLength) + "..."
                        : N(e);
                    ...
                    if (a) a.innerHTML = e;
                      ...
                      (o.id = n1.messageID),
                        ...
                        (o.style.color = n1.messageColor),
                        (o.style.fontSize = n1.messageFontSize),
                        (o.innerHTML = e),
                        i.appendChild(o);
                    }
              ...
              Y1 = function (e3, i3, a4, n3, r, l) {
                ...
                if (Array.isArray(a4)) {
                  ...
                  Object.prototype.isPrototypeOf.call(NodeList.prototype, a4)
                ) {
                  if (1 > a4.length)
                    return (
                      y1(
                ...
                var f = v(!0, o1, {});
                if (
                  ("object" == typeof n3 && !Array.isArray(n3)) ||
                  ("object" == typeof r && !Array.isArray(r))
                ) {
                  var d = {};
                  "object" == typeof n3
                ...
                var x = "";
                "string" == typeof n3 && 0 < n3.length && (x = n3),
                  o1.cssAnimation || (o1.cssAnimationDuration = 0);
                var g = u1.className;
                "string" == typeof o1.className && (g = o1.className.trim());
                var h =
                    "number" == typeof o1.querySelectorLimit
                      ? o1.querySelectorLimit
                      : 200,
                  ...
                  for (
                    ...
                    if (((S = m[X]), S)) {
                      ...
                      if (1 > D.length) {
                        ...
                        i3 &&
                          (i3 === b1.Hourglass
                            ? (T = I1(o1.svgSize, o1.svgColor))
                            : i3 === b1.Circle
                            ? (T = R1(o1.svgSize, o1.svgColor))
                            : i3 === b1.Arrows
                            ? (T = A1(o1.svgSize, o1.svgColor))
                            : i3 === b1.Dots
                            ? (T = M(o1.svgSize, o1.svgColor))
                            : i3 === b1.Pulse
                            ? (T = B(o1.svgSize, o1.svgColor))
                            : (T = W1(o1.svgSize, o1.svgColor)));
                        var F =
                            '<span class="' +
                            g +
                            '-icon" style="width:' +
                        ...
                        0 < x.length &&
                          ((x =
                            x.length > o1.messageMaxLength
                              ? N(x).substring(0, o1.messageMaxLength) + "..."
                              : N(x)),
                          (E =
                        ...
                        (j.id = u1.ID + "-" + Q),
                          (j.className =
                            g + (o1.cssAnimation ? " nx-with-animation" : "")),
                          (j.style.position = o1.position),
                          (j.style.zIndex = o1.zindex),
                          (j.style.background = o1.backgroundColor),
                          (j.style.animationDuration =
                            o1.cssAnimationDuration + "ms"),
                          (j.style.fontFamily =
                            '"' + o1.fontFamily + '", ' + s1),
                        ...
                        var O = t1
                          ...
                          H =
                            "string" == typeof O
                              ...
                              : "relative",
                          P = Math.round(1.25 * parseInt(o1.svgSize)) + 40,
                          U = S.offsetHeight || 0,
                          V = "";
                  ...
                  var _ = function (e) {
                      var i = setTimeout(function () {
                        ...
                        var a = e.getAttribute("id"),
                          n = t1.document.getElementById("Style-" + a);
                        n &&
                          null !== n.parentNode &&
              ...
              G = {
                ...
                Block: {
                  ...
                  remove: function (t, e) {
                    "number" != typeof e && (e = 0),
                      Y1(!1, null, t, null, null, e);
                  },
                },
              };
            return "object" == typeof t1.Notiflix
              ? v(!0, t1.Notiflix, {
                  Notify: G.Notify,
                  Report: G.Report,
                  Confirm: G.Confirm,
...
*/ "use strict";
                  ...
                  var property = (
                    (_ref =
                      allowHTML !== null && allowHTML !== void 0
                        ? allowHTML
                        : this.options.captionHTML) !== null && _ref !== void 0
                      ? _ref
                      : true
                  )
                    ? "innerHTML"
    ...
    lnF2r: [
      function (require, module, exports) {
        ...
        async function getQueryData(searchQuery, page) {
